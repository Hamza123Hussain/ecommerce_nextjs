...
const CartItems = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="grid lg:w-[70vw] md:w-[100vw] grid-cols-1 md:grid-cols-12 gap-6 items-center border p-4 rounded-lg mb-4 hover:shadow-md hover:shadow-blue-100">
