...
const CartPage = () => {
  ...
  return (
    <div className="container mx-auto mt-5 min-h-screen p-2 bg-white dark:bg-white dark:text-black ">
        ...
        <div className="flex-1">
          {cart.length === 0 ? (
            ...
            cart.map((item: Product) => (
              <div
                key={item.id}
                className="flex flex-col md:flex-row items-center   gap-4 mb-4 p-4 "
              >
                <Cartitem item={item} />
              </div>
            ))
